...
public class SyncResponse extends WechatHttpResponseBase {
    ...
    @JsonProperty
    private com.zhongweixian.domain.shared.Profile Profile;
    @JsonProperty
    private int ContinueFlag;
    @JsonProperty
    private com.zhongweixian.domain.shared.SyncKey SyncKey;
    @JsonProperty
    private String SKey;
    @JsonProperty
    private com.zhongweixian.domain.shared.SyncCheckKey SyncCheckKey;
